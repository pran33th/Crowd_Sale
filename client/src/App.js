...
class App extends Component {
  ...
  handleKycWhitelisting = async () => {
    ...
    alert('kyc for this '+ this.state.kycAddress + " has been completed")
  }
  ...
  render() {
    ...
    return (
      ...
      Address to allow: <input type="text" name="kycAddress" value={this.state.kycAddress} onChange={this.handleInputChange} />
       <button type="button" onClick={this.handleKycWhitelisting}>White list</button>
       <h2>Buy tokens</h2>
    <p>If you want to buy tokens, send the wei to this address: {this.state.tokenSaleAddress}</p>
